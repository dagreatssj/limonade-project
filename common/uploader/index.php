...
<head>
	<meta charset="utf-8">
	<title>ADMIN - Uploader | Grim Hearts 1985</title>	
...
<div class="container">
    <div class="page-header">
        <h1>Admin Uploader using jQuery File Upload</h1>
        <br />
        <strong><a href=<?php echo '"http://'.$_SERVER['HTTP_HOST'].'/admin/gh85">'; ?>GO BACK TO ADMIN PAGE</a></strong>
    </div>
    <blockquote>
